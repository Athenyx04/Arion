...
export default function UpdateAnimal() {
  ...
  useEffect(() => {
    const defaultValues = {
      tagId: animalInfo.tagId,
      name: animalInfo.name,
      sex: animalInfo.sex,
      species: animalInfo.species,
      breed: animalInfo.breed,
      dob: animalInfo.formattedDoB,
    };
    reset({ ...defaultValues });
  }, [
    animalInfo.breed,
    animalInfo.formattedDoB,
    animalInfo.name,
    animalInfo.sex,
    animalInfo.species,
    animalInfo.tagId,
          ...
          <div className="flex justify-between items-center">
            <div className="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
              ...
              <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                Use el siguiente formulario para editar su animal.
              </p>
            </div>
          </div>
